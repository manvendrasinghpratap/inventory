  ...
  <div class="row">
					...
					<div class="panel panel-blue">
					   ...
					   <div class="panel-body pan">
						  {{ Form::open(['method'=>'post','url'=>'user/saveAssdetails','files'=>'true','class'=>'form-horizontal','role'=>'form'])}}
							 <div class="form-body pal">
							<div class="row">
							<?php echo $userData->userDetails->user_type_id;?>
							<div class="col-lg-6">
							<div class="form-group">
								   ...
								   <div class="col-md-9">
									  ...
									  {{Form::select('user_type',$userType,$userData->userDetails->user_type_id,array('class' => 'form-control','disabled'))}}
									  </div>
								   </div>
								</div>
								</div>
							  ...
							  <div class="col-lg-6">
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  ...
									  {{ Form::text('name',$userData->userDetails->name,['class' => 'form-control','placeholder' => 'Enter your Name', 'required' => 'required','disabled'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
								   <div class="input-icon"><i class="fa fa-user"></i>
								   {{ Form::text('fathername',$userData->fathername,['class' => 'form-control','placeholder' => 'Enter your Father Name', 'required' => 'required'])}}
									</div>
									</div>
								   </div>
								   <div class="form-group">
								   ...
								   <div class="col-md-9">
								   <div class="input-icon"><i class="fa fa-user"></i>
								   {{ Form::text('mothername',$userData->mothername,['class' => 'form-control','placeholder' => 'Enter your Mother Name', 'required' => 'required'])}}
									</div>
									</div>
								   </div>
								...
								<div class="form-group">
								   <label for="doa" class="col-md-3 control-label">Date Of Association <span class='require'>*</span></label>
								    <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-calendar"></i>									  
									  {{ Form::text('doa',$userData->doa,['class' => 'form-control datepicker','placeholder' => 'Enter your Date Of Association', 'required' => 'required'])}}
									</div>
								   </div>
								</div>
								<div class="form-group">
								   <label for="doj" class="col-md-3 control-label">Date Of Joining <span class='require'>*</span></label>
								    <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-calendar"></i>									  
									  {{ Form::text('doj',$userData->doj,['class' => 'form-control datepicker','placeholder' => 'Enter your DOJ', 'required' => 'required'])}}
									</div>
								   </div>
								</div>
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  ...
									  {{ Form::textarea('paddress' , $userData->paddress , ['class' => 'form-control','size' => '2x5']) }}
									  </div>
								   </div>
								</div>								
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-address-book" aria-hidden="true"></i>
									  {{ Form::textarea('currentaddress' , $userData->currentaddress , ['class' => 'form-control','size' => '2x5']) }}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  ...
									  {{ Form::text('currentpin',$userData->currentpin,['class' => 'form-control','placeholder' => 'Enter your Current Area Pin', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>								
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  ...
									  {{ Form::text('mobile',$userData->mobile,['class' => 'form-control','placeholder' => 'Enter your Mobile number', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-mobile" aria-hidden="true"></i>
									  {{ Form::text('altmobile',$userData->altmobile,['class' => 'form-control','placeholder' => 'Enter your Alternate Mobile number', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="row">
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  ...
									  {{ Form::text('graduatecourse',$userData->graduatecourse,['class' => 'form-control','placeholder' => 'Enter your Graduate Course', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-building" aria-hidden="true"></i>
									  {{ Form::text('graduatecollagename',$userData->graduatecollagename,['class' => 'form-control','placeholder' => 'Enter your Collage Name', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   <label for="graduateyop" class="col-md-3 control-label">Year of passing<span class='require'>*</span></label>
								    <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-calendar"></i>									  
									  {{ Form::text('graduateyop',$userData->graduateyop,['class' => 'form-control datepickeryop','placeholder' => 'Enter your DOJ', 'required' => 'required'])}}
									</div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon">
									  {{ Form::text('graduatemarks',$userData->graduatemarks,['class' => 'form-control','placeholder' => 'Enter your Marks (%)', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="row">
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-building" aria-hidden="true"></i>
									  {{ Form::text('postcourse',$userData->postcourse,['class' => 'form-control','placeholder' => 'Enter your Graduate Course', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-building" aria-hidden="true"></i>
									  {{ Form::text('postcollagename',$userData->postcollagename,['class' => 'form-control','placeholder' => 'Enter your Collage Name', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   <label for="postyop" class="col-md-3 control-label">Year of passing<span class='require'>*</span></label>
								    <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-calendar"></i>									  
									  {{ Form::text('postyop',$userData->postyop,['class' => 'form-control datepickeryop','placeholder' => 'Enter your DOJ', 'required' => 'required'])}}
									</div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon">
									  {{ Form::text('postmarks',$userData->postmarks,['class' => 'form-control','placeholder' => 'Enter your Marks (%)', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('professional1name',$userData->professional1name,['class' => 'form-control','placeholder' => 'Enter your Reference Name'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('professional1relationship',$userData->professional1relationship,['class' => 'form-control','placeholder' => 'Enter your Relationship Name', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
                                <div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-mobile" aria-hidden="true"></i>
									  {{ Form::text('professional1mobile',$userData->professional1mobile,['class' => 'form-control','placeholder' => 'Enter your Mobile number', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
                                <div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('professional1knowing',$userData->professional1knowing,['class' => 'form-control','placeholder' => 'Enter your Time knowing the Reference', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>								
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon">
									  {{ Form::textarea('professional1contactname',$userData->professional1contactname,['class' => 'form-control','placeholder' => 'Enter your Contact Address','size' => '2x5','required' => 'required'])}}
									  </div>
								   </div>
								</div>
                                <div class="row">
                                ...
                                <div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('professional2name',$userData->professional2name,['class' => 'form-control','placeholder' => 'Enter your Reference Name', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('professional2relationship',$userData->professional2relationship,['class' => 'form-control','placeholder' => 'Enter your Relationship Name', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
                                <div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-mobile" aria-hidden="true"></i>
									  {{ Form::text('professional2mobile',$userData->professional2mobile,['class' => 'form-control','placeholder' => 'Enter your Mobile number', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>	
                                 <div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('professional2knowing',$userData->professional2knowing,['class' => 'form-control','placeholder' => 'Enter your Time knowing the Reference', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>								
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon">
									  {{ Form::textarea('professional2contactname',$userData->professional2contactname,['class' => 'form-control','placeholder' => 'Enter your Contact Address','size' => '2x5', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
                                <div class="row">
                                ...
                                <div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('friendname',$userData->friendname,['class' => 'form-control','placeholder' => 'Enter your Reference Name', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('friendrelationship',$userData->friendrelationship,['class' => 'form-control','placeholder' => 'Enter your Relationship Name', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
                                <div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-mobile" aria-hidden="true"></i>
									  {{ Form::text('friendmobile',$userData->friendmobile,['class' => 'form-control','placeholder' => 'Enter your Mobile number', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>	
                                 <div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('friendknowing',$userData->friendknowing,['class' => 'form-control','placeholder' => 'Enter your Time knowing the Reference', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>								
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon">
									  {{ Form::textarea('friendcontactname',$userData->friendcontactname,['class' => 'form-control','placeholder' => 'Enter your Contact Address','size' => '2x5', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>								
								...
								<div class="row">
								 ...
								 <div class="form-group">					
								   ...
								   <div class="col-md-9">
									  ...
									  {{ Form::text('personalaccount',$userData->personalaccount,['class' => 'form-control','placeholder' => 'Enter your Personal Account Number', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								 <div class="form-group">					
								 ...
								 <div class="form-group">					
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-university" aria-hidden="true"></i>
									  {{ Form::text('ifsc',$userData->ifsc,['class' => 'form-control','placeholder' => 'Enter your IFSC code', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								 ...
								 <div class="form-group">					
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-university" aria-hidden="true"></i>
									  {{ Form::text('pancard',$userData->pancard,['class' => 'form-control','placeholder' => 'Enter your Pan card', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								 <div class="form-group">					
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-university" aria-hidden="true"></i>
									  {{ Form::text('aadhar',$userData->aadhar,['class' => 'form-control','placeholder' => 'Enter your Aadhar card', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
