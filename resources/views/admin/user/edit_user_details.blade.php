...
<div class="page-content">
  <div class="row">
					...
					<div class="panel panel-blue">
					   <div class="panel-heading">Update Internal User Details</div>
					   <div class="panel-body pan">
						  {{ Form::open(['method'=>'post','url'=>'user/savedetails','files'=>'true','class'=>'form-horizontal','role'=>'form'])}}
							  ...
							  <div class="col-lg-6">
								...
								<div class="form-group">
								   ...
								   <label for="siblings" class="col-md-3 control-label">Total Siblings<span class='require'>*</span></label>
								    <div class="col-md-9">
									  <div class="input-icon">									  
									  {{ Form::number('siblings',$userData->siblings,['class' => 'form-control','min'=>'0','required' => 'required'])}}
									</div>
								   </div>
								</div>
								<div class="form-group">
								   <label for="dob" class="col-md-3 control-label">Date Of Birth <span class='require'>*</span></label>
									...
									@endphp
									  ...
									  {{ Form::text('dob',$userData->dob,['class' => 'form-control datepicker','placeholder' => 'Enter your DOB', 'required' => 'required','disabled'])}}
									</div>
								   </div>
								</div>
								<div class="form-group">
                                ...
                                <div class="form-group">
								   <label for="kids" class="col-md-3 control-label">No. of Kids<span class='require'>*</span></label>
								    <div class="col-md-9">
									  <div class="input-icon">									  
									  {{ Form::number('kids',$userData->kids,['class' => 'form-control','min'=>'0','required' => 'required'])}}
									</div>
								   </div>
								</div>
								<div class="form-group">
                                ...
                                <div class="form-group">
								   <label for="joiningage" class="col-md-3 control-label">Age at the time of joining<span class='require'>*</span></label>
								    <div class="col-md-9">
									  <div class="input-icon">									  
									  {{ Form::number('joiningage',$userData->joiningage,['class' => 'form-control','min'=>'0','required' => 'required'])}}
									</div>
								   </div>
								</div>								
								<div class="form-group">
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  ...
									  {{ Form::text('ppin',$userData->ppin,['class' => 'form-control','placeholder' => 'Enter your Permanent Area Pin', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  ...
									  {{ Form::text('collagename',$userData->collagename,['class' => 'form-control','placeholder' => 'Enter your Collage Name', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-address-book" aria-hidden="true"></i>
									  {{ Form::textarea('caddress' , $userData->caddress , ['class' => 'form-control','size' => '2x5']) }}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-map-marker" aria-hidden="true"></i>
									  {{ Form::text('cpin',$userData->cpin,['class' => 'form-control','placeholder' => 'Enter your Collage Area Pin', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('referencename',$userData->referencename,['class' => 'form-control','placeholder' => 'Enter your Reference Name'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('relationship',null,['class' => 'form-control','placeholder' => 'Enter your Relationship Name'])}}
									  </div>
								   </div>
								</div>								
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('contactname',$userData->contactname,['class' => 'form-control','placeholder' => 'Enter your Conatct Name'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									 <div class="input-icon"><i class="fa fa-address-book" aria-hidden="true"></i>
									  {{ Form::textarea('contactaddress' , $userData->contactaddress , ['class' => 'form-control','size' => '2x5']) }}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-map-marker" aria-hidden="true"></i>
									  {{ Form::text('contactpin',$userData->contactpin,['class' => 'form-control','placeholder' => 'Enter your Pin code', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
					...
					<div class="row">
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-address-book" aria-hidden="true"></i>
									  {{ Form::text('empid',$userData->empid,['class' => 'form-control','placeholder' => 'Enter your ID', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
					...
					<div class="form-group">
					           ...
					           <div class="form-group">					
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-mobile" aria-hidden="true"></i>
									  {{ Form::text('cugmobile',$userData->cugmobile,['class' => 'form-control','placeholder' => 'Enter your CUG Mobile number', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
								...
								<div class="row">
								 ...
								 <div class="form-group">					
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-university" aria-hidden="true"></i>
									  {{ Form::text('salaryaccount',$userData->salaryaccount,['class' => 'form-control','placeholder' => 'Enter your Salary Account', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
								 <div class="form-group">					
								 ...
								 <div class="form-group">					
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-university" aria-hidden="true"></i>
									  {{ Form::text('passport',$userData->passport,['class' => 'form-control','placeholder' => 'Enter your Passport card', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>								
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  {{ Form::number('salaryamount',$userData->salaryamount,['class' => 'form-control','placeholder' => 'Enter your Salary Ammount', 'min' =>'0','required' => 'required'])}}
								   </div>
								</div>
								<div class="form-group">
								   <label for="tds" class="col-md-3 control-label">TDS to be Deduction (%)<span class='require'>*</span></label>
								   <div class="col-md-9">
									  {{ Form::number('tds',$userData->tds,['class' => 'form-control','placeholder' => 'Enter your TDS to be Deduction', 'min' =>'0','required' => 'required'])}}
								   </div>
								</div>
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  {{ Form::number('advance',$userData->advance,['class' => 'form-control','placeholder' => 'Enter your Advances', 'min' =>'0','required' => 'required'])}}
								   </div>
								</div>
								<div class="form-group">
								   <label for="deductions" class="col-md-3 control-label">Deductions (-)<span class='require'>*</span></label>
								   <div class="col-md-9">
									  {{ Form::number('deductions',$userData->deductions,['class' => 'form-control','placeholder' => 'Enter your Deductions', 'min' =>'0','required' => 'required'])}}
								   </div>
								</div>
								<div class="form-group">
								   <label for="reimbursements" class="col-md-3 control-label">Reimbursements (+)<span class='require'>*</span></label>
								   <div class="col-md-9">
									  {{ Form::number('reimbursements',$userData->reimbursements,['class' => 'form-control','placeholder' => 'Enter your Reimbursements', 'min' =>'0','required' => 'required'])}}
								   </div>
								</div>
								<div class="form-group">
								   <label for="incentives" class="col-md-3 control-label">Incentives (+)<span class='require'>*</span></label>
								   <div class="col-md-9">
									  {{ Form::number('incentives',$userData->incentives,['class' => 'form-control','placeholder' => 'Enter your Incentives', 'min' =>'0','required' => 'required'])}}
								   </div>
								</div>
								<div class="form-group">
								   <label for="totalsalary" class="col-md-3 control-label">Total Salary<span class='require'>*</span></label>
								   <div class="col-md-9">
									  {{ Form::number('totalsalary',$userData->totalsalary,['class' => 'form-control','placeholder' => 'Enter your Total Salary', 'min' =>'0','required' => 'required'])}}
								   </div>
								</div>
								<div class="form-group">					
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-university" aria-hidden="true"></i>
									  {{ Form::text('gst',$userData->gst,['class' => 'form-control','placeholder' => 'Enter your GST Number', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>
