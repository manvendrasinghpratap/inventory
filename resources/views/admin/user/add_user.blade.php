  ...
  <div class="row">
					...
					<div class="panel panel-blue">
					   ...
					   <div class="panel-body pan">
						  {{ Form::open(['method'=>'post','url'=>'admin/addbank','files'=>'true','class'=>'form-horizontal','role'=>'form'])}}
							 ...
							 <!---First Form culomn--->
							  <div class="col-lg-6">
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">								      
									  <label for="Male" class="col-md-3 control-label">{{Form::radio('gender', 'male', true)}} Male</label>									 
									  <label for="Female" class="col-md-6 control-label"> {{Form::radio('gender', 'female', false)}} Female</label>									 
								   </div>
								</div>
								<div class="form-group">
					...
					<div class="row">
								...
								<div class="form-group">
								   <label for="user_band" class="col-md-3 control-label">Band Level<span class='require'>*</span></label>
								   <div class="col-md-9">
									  <div class="input-icon">
									  {{Form::select('user_band',$userBand,null,array('class' => 'form-control','placeholder' => 'Please select'))}}
									  </div>
								   </div>
								</div>
								<div class="form-group">
					...
					<div class="form-group">
					           ...
					           <div class="form-group">					
								...
								<div class="form-group">
								   ...
								   <div class="col-md-9">
									  ...
									  {{ Form::email('officeemailid',null,['class' => 'form-control','placeholder' => 'Enter your Official Email', 'required' => 'required'])}}
									  </div>
								   </div>
								</div>						
								<div class="form-group">
					 ...
					 <div class="form-actions">
						<div class="col-md-offset-3 col-md-9" style="margin-left: 3%;"><button type="submit" class="btn btn-primary">Submit</button>&nbsp;<button type="button" class="btn btn-green">Cancel</button></div>
						</div>
						{{ Form::close() }}
					  </div>
				 </div>
