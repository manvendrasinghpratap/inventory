                           ...
                           <table id="table_id" class="table table-hover table-striped table-bordered table-advanced tablesorter display">
                              ...
                              @foreach($bankdetails as $row)
                                 <tr id="hide_{{ $row->id }}">
                                    <td>{{ $row->bank_name }}</td>                                    
                                    <td>
                                       <a class="btn btn-default btn-xs edit" href="{{ URL::to('editbank/'.\App\Helpers\Common::encodeParam($row->id) ) }}" title="Edit Bank"> <i class="fa fa-edit"></i></a>
                                       <button type="button" class="btn btn-default btn-xs confirmDelete" data-siteurl ="{{ url('/')}}" data-tablename="bank_details" data-record-id="{{ $row->id }}" data-record-title="Are you sure you want to delete this Banks ?" data-toggle="modal" data-target="modal-confirm" data-succuss="Bank deleted successfully">
