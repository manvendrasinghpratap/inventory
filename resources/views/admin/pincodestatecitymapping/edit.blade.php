  ...
  <div class="row">
	 <div class="col-lg-12">
					<div class="panel panel-blue">
					   <div class="panel-heading">Edit Pin code State City Mapping</div>
					   <div class="panel-body pan">
						  {{ Form::open(['method'=>'post','url'=>'updatepinstatecitymaps','files'=>'true','class'=>'form-horizontal','role'=>'form'])}}
						   {{ Form::hidden('id', $pincodedetails['id'], array('name'=>'id')) }}
							 <div class="form-body pal">
								 <div class="form-group {{ $errors->has('pincode') ? 'has-error' : '' }}">
								   <label for="name" class="col-md-3 control-label">Pin code<span class='require'>*</span></label>
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('pincode', $pincodedetails['pincode'], array('class' => 'form-control','placeholder'=>"Pincode")) }}
								 ...
								 <div class="form-group {{ $errors->has('area_location') ? 'has-error' : '' }}">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-pincode"></i>
									   {{ Form::textarea('area_location', $pincodedetails['area_location'], array('row'=>1,'col'=>2,'class' => 'form-control','placeholder'=>"Location (Area Name)")) }}
								 ...
								 <div class="form-group {{ $errors->has('state_id') ? 'has-error' : '' }}">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-pincode"></i>
								       {{ Form::select('state_id', $state,$pincodedetails['state_id'], array('id'=>'state_id','class' => 'form-control-select','placeholder'=>"Select State")) }}
								 ...
								 <div class="form-group {{ $errors->has('city_id') ? 'has-error' : '' }}">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-pincode"></i>
										  {{ Form::select('city_id', $cities,$pincodedetails['city_id'], array('id'=>'city_id','class' => 'form-control-select','placeholder'=>"Select City")) }}
								 ...
								 <div class="form-group {{ $errors->has('geographical_location') ? 'has-error' : '' }}">
								   ...
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-pincode"></i>
										  {{ Form::select('geographical_location', $geographical_location,$pincodedetails['geographical_location'], array('id'=>'geographical_location','class' => 'form-control-select','placeholder'=>"Geographical Location of country")) }}
