                           ...
                           <table id="table_id" class="table table-hover table-striped table-bordered table-advanced tablesorter display">
                              ...
                              @foreach($categories as $row)
                                 <tr id="hide_{{ $row->id }}">
                                    ...
                                    <td>{{ $row->rate }}</td>                                    
                                    <td>
                                       <a class="btn btn-default btn-xs edit" href="{{ URL::to('editCategory/'.\App\Helpers\Common::encodeParam($row->id) ) }}" title="Edit Category"> <i class="fa fa-edit"></i></a>
                                       <button type="button" class="btn btn-default btn-xs confirmDelete" data-siteurl ="{{ url('/')}}" data-tablename="categories" data-record-id="{{ $row->id }}" data-record-title="Are you sure you want to delete this Category ?" data-toggle="modal" data-target="modal-confirm" data-succuss="Category deleted successfully">
