	 ...
	 <div class="col-lg-12">
					<div class="panel panel-blue">
					   ...
					   <div class="panel-body pan">
						  {{ Form::open(['method'=>'post','url'=>'updateCategory','files'=>'true','class'=>'form-horizontal','role'=>'form'])}}
						   {{ Form::hidden('id', $categorydetails['id'], array('name'=>'id')) }}
							 <div class="form-body pal">
								 <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
								   <label for="name" class="col-md-3 control-label">Category Name <span class='require'>*</span></label>
								   <div class="col-md-9">
									  <div class="input-icon"><i class="fa fa-user"></i>
									  {{ Form::text('name', $categorydetails['name'], array('class' => 'form-control','placeholder'=>"Bank Name")) }}
