                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="portlet-body pan">
                           <table id="table_id" class="table table-hover table-striped table-bordered table-advanced tablesorter display">
                              <thead>
                              <tr>
                                 <th width="9%">Bank Name</th>
                                 <th width="9%">Action</th>
                              </tr>
                              <tbody>
                              <?php $__currentLoopData = $bankdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <tr id="hide_<?php echo e($row->id); ?>">
                                    <td><?php echo e($row->bank_name); ?></td>                                    
                                    <td>
                                       <a class="btn btn-default btn-xs edit" href="<?php echo e(URL::to('editbank/'.\App\Helpers\Common::encodeParam($row->id) )); ?>" title="Edit Bank"> <i class="fa fa-edit"></i></a>
                                       <button type="button" class="btn btn-default btn-xs confirmDelete" data-siteurl ="<?php echo e(url('/')); ?>" data-tablename="bank_details" data-record-id="<?php echo e($row->id); ?>" data-record-title="Are you sure you want to delete this Banks ?" data-toggle="modal" data-target="modal-confirm" data-succuss="Bank deleted successfully">
