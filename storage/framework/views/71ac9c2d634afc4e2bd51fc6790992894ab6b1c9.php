	 ...
	 <div class="col-lg-12">
					<div class="panel panel-blue">
					   ...
					   <div class="panel-body pan">
						  <?php echo e(Form::open(['method'=>'post','url'=>'addbank','files'=>'true','class'=>'form-horizontal','role'=>'form'])); ?>
							 ...
							 <div class="form-body pal">
								 <div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
								   ...
								   <div class="col-md-9">
									  ...
									  <?php echo e(Form::text('name', '', array('class' => 'form-control','placeholder'=>"Bank Name"))); ?>
