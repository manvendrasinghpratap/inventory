        ...
        <ul id="side-menu" class="nav">
            ...
            <li class=" <?php if((Request::segment(1)=='banks') || (Request::segment(1)=='addbank') || (Request::segment(1)=='editbank') || (Request::segment(1)=='categories') || (Request::segment(1)=='addCategory')||(Request::segment(1)=='editCategory') ||(Request::segment(1)=='products') ||(Request::segment(1)=='addProduct') ||(Request::segment(1)=='editProduct')): ?> active !!}<?php endif; ?>">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li style="display: none;"><a href="<?php echo e(url('/categories')); ?>"><i class="fa fa-rocket"></i><span class="submenu-title">Category</span></a></li>
                    <li><a href="<?php echo e(url('/products')); ?>"><i class="fa fa-rocket"></i><span class="submenu-title">Product</span></a></li>                   
                </ul>
            </li>
            <li class=" <?php if((Request::segment(1)=='generateInvoice') || (Request::segment(1)=='invoices')): ?> active !!}<?php endif; ?>">
                <a href="#">
                    <i class="fa fa-user fa-fw">
                        <div class="icon-bg bg-pink"></div>
                    </i>
                ...
                <ul class="nav nav-second-level">
                    <li><a href="<?php echo e(url('/invoices')); ?>"><i class="fa fa-rocket"></i><span class="submenu-title">Invoices</span></a></li>                   
                    <li><a href="<?php echo e(url('/generateInvoice')); ?>"><i class="fa fa-rocket"></i><span class="submenu-title">Generate Invoice</span></a></li>                   
                </ul>
            </li>
        </ul>
    </div>
